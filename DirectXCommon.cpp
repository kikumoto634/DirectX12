...
void DirectXCommon::PreDraw()
{
	...
	///ビューポート
	//設定コマンド
	CD3DX12_VIEWPORT viewport = CD3DX12_VIEWPORT(CD3DX12_VIEWPORT(0.0f, 0.0f, float(backBufferWidth), float(backBufferHeight)));
	commandList->RSSetViewports(1, &viewport);
		 
	///シザー矩形
	//設定
	CD3DX12_RECT rect = CD3DX12_RECT(0, 0, backBufferWidth, backBufferHeight);
